use gitcg_sim::{data_structures::LinkedList, linked_list, prelude::PlayerId};
use std::ops::Add;
...
pub mod rule_based {
    use gitcg_sim::{linked_list, prelude::*, rule_based::*};
...
impl SearchCounter {
    ...
    #[cfg(not(feature = "detailed_search_stats"))]
    pub const ZERO: SearchCounter = SearchCounter {
        states_visited: 0,
        evals: 0,
        tt_hits: 0,
...
pub mod prelude {
    pub use super::{Game, GameTreeSearch, SearchCounter, SearchLimits, SearchResult};
}
